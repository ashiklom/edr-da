...
%.css: 
	...
	Rscript testruns/generate_testrun_multi_cohort_USWCr.R $(dt) $(pfts) $(st) $(stand_type)
...
clean:
	rm -rf ed-inputs/sites/US-WCr/rtm/1cohort ed-inputs/sites/$(site)/rtm/3cohort/ \
	    run-ed/1cohort run-ed/3cohort run-ed/template/ed_2.1 run-ed/template/ed_2.1-opt \
