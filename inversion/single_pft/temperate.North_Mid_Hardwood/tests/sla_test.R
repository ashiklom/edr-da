...
#--------------------------------------------------------------------------------------------------#
pft <- "temperate.North_Mid_Hardwood"
...
spectra_list <- list(temperate.North_Mid_Hardwood = prospect(pp, 5, TRUE))
tv1 <- list(temperate.North_Mid_Hardwood = list(SLA = 1))
tv2 <- list(temperate.North_Mid_Hardwood = list(SLA = 5))
tv3 <- list(temperate.North_Mid_Hardwood = list(SLA = 25))
tv4 <- list(temperate.North_Mid_Hardwood = list(SLA = 50))
...
legend("topright",legend=c(paste0("SLA: ",unlist(tv1$temperate.North_Mid_Hardwood$SLA)),
                           paste0("SLA: ",unlist(tv2$temperate.North_Mid_Hardwood$SLA)),
                           paste0("SLA: ",unlist(tv3$temperate.North_Mid_Hardwood$SLA)),
                           paste0("SLA: ",unlist(tv4$temperate.North_Mid_Hardwood$SLA))),bty="n",
