...
tv1 <- list(temperate.Late_Hardwood = list(SLA = 1))
tv2 <- list(temperate.Late_Hardwood = list(SLA = 5))
tv3 <- list(temperate.Late_Hardwood = list(SLA = 25))
tv4 <- list(temperate.Late_Hardwood = list(SLA = 50))
...
legend("topright",legend=c(paste0("SLA: ",unlist(tv1$temperate.Late_Hardwood$SLA)),
                           paste0("SLA: ",unlist(tv2$temperate.Late_Hardwood$SLA)),
                           paste0("SLA: ",unlist(tv3$temperate.Late_Hardwood$SLA)),
                           paste0("SLA: ",unlist(tv4$temperate.Late_Hardwood$SLA))),bty="n",
