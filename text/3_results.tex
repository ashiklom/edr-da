...
Model calibration substantially improved the precision of all parameter estimates for all PFTs, even when prior distributions were strongly informative (Figure~\ref{fig:posterior-pft}).
...
On average, evergreen-dominated sites had slightly drier soils than hardwood-dominated sites
(mean soil moisture estimate was 0.51 for evergreen fraction $< 0.5$ vs. 0.45 for evergreen fraction $\geq 0.5$),
but variability among both evergreen- and hardwood-dominated sites was large.
...
\begin{figure}
  ...
  \caption{\label{fig:spec_error_vis}\
...
% The ability of EDR to reproduce observed spectra at every site was strongly site-dependent (Figure~\ref{fig:spec-error-all}).
