...
\begin{figure}
  \centering
  \includegraphics[height=0.6\textheight,keepaspectratio]{figures/posterior-pft}
...
\begin{figure}
  \centering
  \includegraphics[height=0.4\textheight,keepaspectratio]{figures/spec-error-aggregate}
...
\begin{figure}
  \centering
  \includegraphics[height=0.4\textheight,keepaspectratio]{figures/lai-pred-obs}
  \caption{\
