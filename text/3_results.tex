...
Across all PFT-specific parameters, the posterior 95\% credible interval (CI) was, on average, 4\% the size of the prior credible interval and, at most, 16\% the size of the prior credible interval.
The most constrained parameters on average were the leaf biomass allometry (2\% of prior CI), wood biomass allometry (3\% of prior CI), and specific leaf area (3\% of prior CI),
and the least constrained parameters on average were the PROSPECT leaf water content (5\% of prior CI) and PROSPECT effective number of leaf layers (4\% of prior CI).
By PFT, the largest relative constraint was for North Mid Hardwood (3\% of prior CI) and the smallest relative constraint was for Late Hardwood (5\% of prior CI).
