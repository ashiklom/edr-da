...
\begin{abstract}
  ...
  We conclude that modeling surface reflectance is a promising avenue for calibration and validation of dynamic vegetation models using remote sensing data.
\end{abstract}
