...
\begin{abstract}
  ...
  Calibration and validation of vegetation models based on their shortwave (300 to 2500 \unit{nm}) radiative transfer outputs can be an effective constraint on a variety of model processes.
  ...
  In addition, we also highlight that our specific implementation is only valid for hemispherical reflectance data (a.k.a., albedo), whereas most surface reflectance products actually estimate the directional reflectance factor.
