...
For wood reflectance, we used a single representative spectrum---the mean of all wood spectra from \citet{asner_1998_biophysical} Asner (1998), resampled to 1 nm resolution---for all PFTs.
